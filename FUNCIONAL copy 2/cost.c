...
/*   Updated: 2024/02/13 12:04:26 by amile-ge         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int cost(t_stack *stackx,int smalle,char type)
{
    ...
    int l;
        ...
        if (type == 'c')
        {
            ...
            return 1;// 1 es que esta mas cerca de arriba, es mas barato llevarlo al primer por arriba
        else
            return 0; //0 es que esta mas cerca del final, es mas barato llevarlo al primero por abajo
